...
alias syu='sudo nixos-rebuild switch --flake "${DOTNIX_ROOT:-$HOME/dotnix}#default" && sudo rkhunter --propupd'
alias pacref='cd "${DOTNIX_ROOT:-$HOME/dotnix}" && nix flake update'
alias p='pulsemixer'
alias r='ranger'
